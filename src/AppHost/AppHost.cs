...
var minecraft = builder.AddContainer("minecraft", "itzg/minecraft-server")
    ...
    .WithEndpoint(targetPort: 25575, port: 25575, name: "rcon", scheme: "tcp")
    .WithEndpoint(targetPort: 8100, port: 8100, name: "bluemap", scheme: "http")
...
var worldGen = builder.AddProject<Projects.WorldGen_Worker>("worldgen-worker")
    ...
    .WithEnvironment("Rcon__Port", "25575")
